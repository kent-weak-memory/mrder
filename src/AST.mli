type value = int [@@deriving to_yojson]
type register = string [@@deriving to_yojson]
type global = string [@@deriving to_yojson]
type comment = string
...
(* Required for IMM *)
type exclusivity = Exclusive | NotExclusive [@@deriving to_yojson]
type rmw_strength = Normal | Strong [@@deriving to_yojson]
...
val show_boolean_expr : boolean_expr -> string
